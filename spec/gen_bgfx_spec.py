...
BGFX_BUILTINS = {
    ...
    "attributes": [
        {"name": "a_position", "type_hint": "vec4", "semantic": "POSITION"},
        {"name": "a_normal", "type_hint": "vec4", "semantic": "NORMAL"},
        {"name": "a_tangent", "type_hint": "vec4", "semantic": "TANGENT"},
        {"name": "a_bitangent", "type_hint": "vec4", "semantic": "BITANGENT"},
        {"name": "a_color0", "type_hint": "vec4", "semantic": "COLOR0"},
        {"name": "a_color1", "type_hint": "vec4", "semantic": "COLOR1"},
        {"name": "a_color2", "type_hint": "vec4", "semantic": "COLOR2"},
        {"name": "a_color3", "type_hint": "vec4", "semantic": "COLOR3"},
        {"name": "a_indices", "type_hint": "vec4", "semantic": "INDICES"},
        {"name": "a_weight", "type_hint": "vec4", "semantic": "WEIGHT"},
        {"name": "a_texcoord0", "type_hint": "vec4", "semantic": "TEXCOORD0"},
        {"name": "a_texcoord1", "type_hint": "vec4", "semantic": "TEXCOORD1"},
        {"name": "a_texcoord2", "type_hint": "vec4", "semantic": "TEXCOORD2"},
        {"name": "a_texcoord3", "type_hint": "vec4", "semantic": "TEXCOORD3"},
        {"name": "a_texcoord4", "type_hint": "vec4", "semantic": "TEXCOORD4"},
        {"name": "a_texcoord5", "type_hint": "vec4", "semantic": "TEXCOORD5"},
        {"name": "a_texcoord6", "type_hint": "vec4", "semantic": "TEXCOORD6"},
        {"name": "a_texcoord7", "type_hint": "vec4", "semantic": "TEXCOORD7"},
        {"name": "i_data0", "type_hint": "vec4", "semantic": "TEXCOORD4"},
        {"name": "i_data1", "type_hint": "vec4", "semantic": "TEXCOORD5"},
        {"name": "i_data2", "type_hint": "vec4", "semantic": "TEXCOORD6"},
        {"name": "i_data3", "type_hint": "vec4", "semantic": "TEXCOORD7"},
        {"name": "i_data4", "type_hint": "vec4", "semantic": "TEXCOORD8"},
    ],
    "varying_semantics": [
        {"name": "POSITION", "type_hint": "vec4", "description": "Vertex position in clip space. Written by vertex shader, read by fragment shader via `gl_FragCoord` or custom varying."},
        {"name": "NORMAL", "type_hint": "vec3", "description": "Surface normal vector. Typically normalized. Used in lighting calculations."},
        {"name": "TANGENT", "type_hint": "vec4", "description": "Surface tangent vector. W component indicates handedness for bitangent calculation."},
        {"name": "BITANGENT", "type_hint": "vec3", "description": "Surface bitangent (binormal) vector. Derived from normal and tangent."},
        {"name": "COLOR0", "type_hint": "vec4", "description": "Vertex color 0. Interpolated across the primitive and available in fragment shader."},
        {"name": "COLOR1", "type_hint": "vec4", "description": "Vertex color 1. Second color channel for two-color vertex lighting."},
        {"name": "COLOR2", "type_hint": "vec4", "description": "Vertex color 2."},
        {"name": "COLOR3", "type_hint": "vec4", "description": "Vertex color 3."},
        {"name": "TEXCOORD0", "type_hint": "vec4", "description": "Texture coordinate set 0. Most commonly vec2 for standard UV mapping."},
        {"name": "TEXCOORD1", "type_hint": "vec4", "description": "Texture coordinate set 1. Used for lightmaps, detail maps, etc."},
        {"name": "TEXCOORD2", "type_hint": "vec4", "description": "Texture coordinate set 2."},
        {"name": "TEXCOORD3", "type_hint": "vec4", "description": "Texture coordinate set 3."},
        {"name": "TEXCOORD4", "type_hint": "vec4", "description": "Texture coordinate set 4."},
        {"name": "TEXCOORD5", "type_hint": "vec4", "description": "Texture coordinate set 5."},
        {"name": "TEXCOORD6", "type_hint": "vec4", "description": "Texture coordinate set 6."},
        {"name": "TEXCOORD7", "type_hint": "vec4", "description": "Texture coordinate set 7."},
        {"name": "INDICES", "type_hint": "vec4", "description": "Bone indices for skeletal animation. Packed as vec4 with 4 byte-sized indices."},
        {"name": "WEIGHT", "type_hint": "vec4", "description": "Bone weights for skeletal animation. Up to 4 bone influences per vertex."},
        {"name": "SV_POSITION", "type_hint": "vec4", "description": "HLSL semantic: Clip-space position. Maps to `POSITION` in GLSL."},
        {"name": "SV_DEPTH", "type_hint": "float", "description": "HLSL semantic: Fragment depth output. Maps to `gl_FragDepth` in GLSL."},
        {"name": "SV_TARGET0", "type_hint": "vec4", "description": "HLSL semantic: Render target 0 output. Maps to `gl_FragData[0]` or `gl_FragColor` in GLSL."},
        {"name": "SV_TARGET1", "type_hint": "vec4", "description": "HLSL semantic: Render target 1 output."},
        {"name": "SV_TARGET2", "type_hint": "vec4", "description": "HLSL semantic: Render target 2 output."},
        {"name": "SV_TARGET3", "type_hint": "vec4", "description": "HLSL semantic: Render target 3 output."},
        {"name": "SV_TARGET4", "type_hint": "vec4", "description": "HLSL semantic: Render target 4 output."},
        {"name": "SV_TARGET5", "type_hint": "vec4", "description": "HLSL semantic: Render target 5 output."},
